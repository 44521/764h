...
wget -O w7x64.img https://app.vagrantup.com/robertsavesave/boxes/save/versions/86/providers/virtualbox.box
echo "Download ngrok"
...
echo "===================================="
echo "Username: nackerbick"
echo "Password: Hoangbach2011@"
echo "===================================="
echo "===================================="
